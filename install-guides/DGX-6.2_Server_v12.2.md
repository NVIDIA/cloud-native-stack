# NVIDIA Cloud Native Stack v12.2 - Install Guide for DGX
## Introduction
...
```
```
 sudo apt install -y -q kubelet=1.29.6-00 kubectl=1.29.6-00 kubeadm=1.29.6-00
```
```
...
#yourhost        Ready    control-plane,master   10m   v1.29.6
```
...
gpu-operator-1606173805 nvidia-gpu-operator            1               2024-03-20 20:23:28.063421701 +0000 UTC deployed        gpu-operator-24.3.0      v24.3.0
