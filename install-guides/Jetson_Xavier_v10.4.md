# NVIDIA Cloud Native Stack - v10.4 Install Guide for Jetson AGX Xavier or Jetson Xavier NX DevKit or Jetson Orin
...
```
sudo apt-get update && sudo apt install nvidia-container-toolkit=1.14.6-1
```
...
```
 sudo apt-get update
 sudo apt-get install -y -q kubelet=1.27.10-00 kubectl=1.27.10-00 kubeadm=1.27.10-00
