# NVIDIA Cloud Native Stack v10.5 - Install Guide for RHEL Server
## Introduction
...
NVIDIA Cloud Native Stack v10.5 includes:
- RHEL 8.8/RHEL 8.8
- Containerd 1.7.16
...
```
 sudo dnf install -y kubelet-1.27.12 kubeadm-1.27.12 kubectl-1.27.12
```
...
```
sudo kubeadm init --pod-network-cidr=192.168.32.0/22 --cri-socket=/run/containerd/containerd.sock --kubernetes-version="v1.27.12"
```

Eecute the following command for `CRI-O` systems:

```
sudo kubeadm init --pod-network-cidr=192.168.32.0/22 --cri-socket=unix:/run/crio/crio.sock --kubernetes-version="v1.27.12"
```
...
#yourhost        Ready    control-plane          10m   v1.27.12
```
...
NAME             STATUS   ROLES                  AGE   VERSION
#yourhost        Ready    control-plane          10m   v1.27.12
#yourhost-worker Ready                           10m   v1.27.12
```
