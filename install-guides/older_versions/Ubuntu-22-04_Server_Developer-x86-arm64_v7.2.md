<h1>NVIDIA Cloud Native Stack v7.2 - Install Guide for Developers</h1>
<h2>Introduction</h2>
...
NVIDIA Cloud Native Stack v7.2includes:
- Ubuntu 22.04 LTS
- Containerd 1.6.10
- Kubernetes version 1.24.8
- Helm 3.11.0
- NVIDIA GPU Driver: 520.61.05
- NVIDIA Container Toolkit: 22.9
...
```
 sudo kubeadm init --pod-network-cidr=192.168.0.0/16 --cri-socket=/run/containerd/containerd.sock --kubernetes-version="v1.24.8"
```
...
#yourhost        Ready    control-plane,master   10m   v1.24.8
```
