# Optimizations for NVIDIA GB300 NVL72

## Introduction
This page outlines the recommended operating system optimizations for the GB300 Compute Tray to maximize performance and efficiency when running containerized workloads.
...
## OS Optimizations
When the CNS Ansible Playbook detects that it is running on the GB300 platform, the following OS optimizations are automatically applied (see the reference provided in the Useful Links section):
* Init on Alloc
