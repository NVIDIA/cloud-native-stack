<h1>NVIDIA Cloud Native Stack v5.2 - Install Guide for Ubuntu Server x86-64</h1>
<h2>Introduction</h2>
...
NVIDIA Cloud Native Stack v5.2 includes:
- Ubuntu 20.04.4 LTS
- Containerd 1.4.9
...
```
 helm install --version 1.10.1 --create-namespace --namespace gpu-operator-resources nvidia/gpu-operator --set driver.version=510.47.03 --wait --generate-name
```
...
```
 helm install --version 1.10.1 --create-namespace --namespace gpu-operator-resources nvidia/gpu-operator  --set driver.rdma.enabled=true --set driver.version=510.47.03 --wait --generate-name
```
...
```
 helm install --version 1.10.1 --create-namespace --namespace gpu-operator-resources nvidia/gpu-operator --set driver.rdma.enabled=true,driver.rdma.useHostMofed=true --set driver.version=510.47.03 --wait --generate-name 
