<h1>NVIDIA Cloud Native Stack v10.2 - Install Guide for DGX</h1>
<h2>Introduction</h2>
...
```
```
 sudo apt-get install -y -q kubelet=1.27.4-00 kubectl=1.27.4-00 kubeadm=1.27.4-00
```
```
...
#yourhost        Ready    control-plane,master   10m   v1.27.4
```
...
gpu-operator-1606173805 nvidia-gpu-operator            1               2023-04-14 20:23:28.063421701 +0000 UTC deployed        gpu-operator-23.6.1      v23.6.1
