# NVIDIA Cloud Native Stack v7.5 - Install Guide for Ubuntu Server
## Introduction
...
```
 sudo apt install -y -q kubelet=1.24.14-00 kubectl=1.24.14-00 kubeadm=1.24.14-00
```
...
gpu-operator-1606173805 nvidia-gpu-operator         1               2023-06-14 20:23:28.063421701 +0000 UTC deployed        gpu-operator-23.3.2      23.3.2 
