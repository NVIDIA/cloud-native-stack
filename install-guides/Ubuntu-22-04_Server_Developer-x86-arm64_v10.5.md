# NVIDIA Cloud Native Stack v10.5 - Install Guide for Developers
## Introduction
...
```
```
 sudo apt-get install -y -q kubelet=1.27.12-00 kubectl=1.27.12-00 kubeadm=1.27.12-00
```
```
...
#yourhost        Ready    control-plane,master   10m   v1.27.12
```
