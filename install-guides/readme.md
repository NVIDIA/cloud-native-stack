...
- [AWS - Ubuntu Server v.2.0](https://github.com/NVIDIA/egx-platform/blob/master/install-guides/AWS_Ubuntu_Server_v2.0.md)
- [AWS - Ubuntu Server v.3.1](https://github.com/NVIDIA/egx-platform/blob/master/install-guides/AWS_Ubuntu_Server_v3.1.md)
