<h1>NVIDIA Cloud Native Stack v7.0 for AWS - Install Guide for Ubuntu Server x86-64</h1>
<h2>Introduction</h2>
...
Execute the following command to download Helm 3.9.0: 
...
For additional information about Helm, refer to the Helm 3.9.0 [release notes](https://github.com/helm/helm/releases) and the [Installing Helm guide](https://helm.sh/docs/using_helm/#installing-helm) for more information. 
...
```
NAME             STATUS   ROLES                  AGE   VERSION
#yourhost        Ready    control-plane,master   10m   v1.24.2
