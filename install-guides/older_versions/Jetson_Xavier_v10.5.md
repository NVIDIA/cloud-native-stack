# NVIDIA Cloud Native Stack - v10.5 Install Guide for Jetson AGX Xavier or Jetson Xavier NX DevKit or Jetson Orin
...
```
sudo apt-get update && sudo apt install nvidia-container-toolkit=1.15.0-1
```
