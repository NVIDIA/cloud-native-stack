<h1>EGX Stack v4.2 - Install Guide for Ubuntu Server x86-64</h1>
<h2>Introduction</h2>

This document describes how to set up NVIDIA EGX Stack v4.2 on single or multiple servers to deploy AI applications via Helm charts from NVIDIA NGC. EGX Stack v4.2 will include:
