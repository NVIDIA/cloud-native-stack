<h1>NVIDIA Cloud Native Stack v6.1 - Install Guide for Ubuntu Server x86-64</h1>
<h2>Introduction</h2>
...
```
 helm install --version 1.10.1 --create-namespace --namespace gpu-operator-resources nvidia/gpu-operator --wait --generate-name
```
...
```
 helm install --version 1.10.1 --create-namespace --namespace gpu-operator-resources nvidia/gpu-operator  --set driver.rdma.enabled=true  --wait --generate-name
```
...
```
 helm install --version 1.10.1 --create-namespace --namespace gpu-operator-resources nvidia/gpu-operator --set driver.rdma.enabled=true,driver.rdma.useHostMofed=true --wait --generate-name 
