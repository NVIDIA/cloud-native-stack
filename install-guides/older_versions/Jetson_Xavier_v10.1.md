# NVIDIA Cloud Native Stack - v10.1 Install Guide for Jetson AGX Xavier or Jetson Xavier NX DevKit or Jetson Orin
...
```
sudo apt update && sudo apt install nvidia-container-toolkit=1.13.2-1
```
