<h1>NVIDIA Cloud Native Stack v8.1 - Install Guide for Developers</h1>
<h2>Introduction</h2>
...
```
 sudo kubeadm init --pod-network-cidr=192.168.0.0/16 --cri-socket=/run/containerd/containerd.sock --kubernetes-version="v1.25.4"
```
