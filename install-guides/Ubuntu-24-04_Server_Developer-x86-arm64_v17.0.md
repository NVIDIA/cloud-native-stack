# NVIDIA Cloud Native Stack v17.0 - Install Guide for Developers
## Introduction
...
NVIDIA Cloud Native Stack v17.0 includes:
- Ubuntu 24.04 LTS
- Containerd 2.2.0
...
```
```
 sudo apt install -y -q kubelet=1.34.2-1.1  kubectl=1.34.2-1.1  kubeadm=1.34.2-1.1 
```
```
...
#yourhost        Ready    control-plane,master   10m   v1.34.2
```
