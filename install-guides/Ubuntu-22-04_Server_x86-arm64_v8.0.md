<h1>NVIDIA Cloud Native Stack v8.0 - Install Guide for Ubuntu Server</h1>
<h2>Introduction</h2>
...
```
 sudo kubeadm init --pod-network-cidr=192.168.0.0/16 --cri-socket=/run/containerd/containerd.sock --kubernetes-version="v1.25.2"
```
...
gpu-operator-1606173805 gpu-operator-resources         1               2022-24-03 20:23:28.063421701 +0000 UTC deployed        gpu-operator-22.09      22.09 
...
NAME            	NAMESPACE       	REVISION	UPDATED                                	STATUS  	CHART                 	APP VERSION
network-operator	network-operator	1       	2022-24-03 17:09:04.665593336 +0000 UTC	deployed	network-operator-1.3.0	v1.3.0
