<h1>EGX Stack - v4.0 Install Guide for Jetson Xavier NX DevKit</h1>

<h2>Introduction</h2>

This document describes how to set up EGX Stack Version 4.0 on a Jetson Xavier NX DevKit to deploy AI applications via Helm charts from NGC. 
