# NVIDIA Cloud Native Stack v12.1 - Install Guide for DGX
## Introduction
...
```
```
 sudo apt-get install -y -q kubelet=1.29.4-00 kubectl=1.29.4-00 kubeadm=1.29.4-00
```
```
...
#yourhost        Ready    control-plane,master   10m   v1.29.4
```
