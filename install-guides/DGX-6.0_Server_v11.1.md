...
```
```
 sudo apt-get install -y -q kubelet=1.28.6-00 kubectl=1.28.6-00 kubeadm=1.28.6-00
```
```
...
#yourhost        Ready    control-plane,master   10m   v1.28.6
```
...
gpu-operator-1606173805 nvidia-gpu-operator            1               2024-03-29 20:23:28.063421701 +0000 UTC deployed        gpu-operator-23.9.1      v23.9.1
