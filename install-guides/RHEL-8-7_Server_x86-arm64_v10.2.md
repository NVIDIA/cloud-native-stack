<h1>NVIDIA Cloud Native Stack v10.2 - Install Guide for RHEL Server</h1>
<h2>Introduction</h2>
...
```
 helm install --version 23.6.0 --create-namespace --namespace nvidia-gpu-operator nvidia/gpu-operator --wait --generate-name
```
...
gpu-operator-1606173805 nvidia-gpu-operator         1               2023-03-14 20:23:28.063421701 +0000 UTC deployed        gpu-operator-23.6.0      v23.3.2 
