# NVIDIA Cloud Native Stack v10.5 - Install Guide for DGX
## Introduction
...
```
```
 sudo apt install -y -q kubelet=1.27.7-00 kubectl=1.27.7-00 kubeadm=1.27.7-00
```
```
...
gpu-operator-1606173805 nvidia-gpu-operator            1               2023-04-14 20:23:28.063421701 +0000 UTC deployed        gpu-operator-24.3.0      v24.3.0
