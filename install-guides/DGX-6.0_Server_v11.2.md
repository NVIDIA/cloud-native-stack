# NVIDIA Cloud Native Stack v11.2 - Install Guide for DGX
## Introduction
...
```
```
 sudo apt-get install -y -q kubelet=1.28.8-00 kubectl=1.28.8-00 kubeadm=1.28.8-00
```
```
...
#yourhost        Ready    control-plane,master   10m   v1.28.8
```
...
Execute the following command to download and install Helm 3.14.4: 
