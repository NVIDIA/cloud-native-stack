# NVIDIA Cloud Native Stack v12.0 - Install Guide for Ubuntu Server
## Introduction
...
#yourhost        Ready    control-plane          10m   v1.29.2
```
...
```
helm install --version 23.9.2 --create-namespace --namespace nvidia-gpu-operator nvidia/gpu-operator  --set driver.version=550.54.15 --wait --generate-name
```
