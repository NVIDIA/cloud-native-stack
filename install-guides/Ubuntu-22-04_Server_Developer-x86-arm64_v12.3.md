# NVIDIA Cloud Native Stack v12.3 - Install Guide for Developers
## Introduction
...
```
```
 sudo apt-get install -y -q kubelet=1.29.10-00 kubectl=1.29.10-00 kubeadm=1.29.10-00
```
```
...
#yourhost        Ready    control-plane,master   10m   v1.29.10
```
