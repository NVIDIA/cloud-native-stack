...
|  Batch  | Status              |
| :-----: | :--------------:|
| [25.11.0](https://github.com/NVIDIA/cloud-native-stack/releases/tag/v25.7.1)                   | Generally Available | 
| [25.7.2](https://github.com/NVIDIA/cloud-native-stack/releases/tag/v25.7.1)                   | Maintenance | 
| [25.7.1](https://github.com/NVIDIA/cloud-native-stack/releases/tag/v25.7.0)                   | EOL | 
...
#### Cloud Native Stack Batch 25.11.0 (Release Date: 2nd October 2025)
...
| NVIDIA Container Toolkit  | 1.18.0 | 1.18.0 | 1.18.0 |
| CRI-O                     | 1.34.2 | 1.33.6 | 1.32.10 |
| Kubernetes                | 1.34.2 | 1.33.6 | 1.32.10 |
| CNI (Calico)              | 3.31.0 | 3.31.0 |  3.31.0 |
| NVIDIA GPU Operator       | 25.10.0 | 25.10.0 | 25.10.0 |
| NVIDIA Network Operator   |  N/A   | 25.7.0 | 25.7.0 |
| NVIDIA NIM Operator       | 3.0.1  | 3.0.1  | 3.0.1  |
...
| Monitoring                | Prometheus: 78.5.0 <br /> Prometheus Adapter: 5.2.0 <br /> Elastic: 9.0.0 | Prometheus: 78.5.0 <br /> Prometheus Adapter: 5.2.0 <br /> Elastic: 9.0.0 | Prometheus: 78.5.0 <br /> Prometheus Adapter: 4.14.1 <br /> Elastic: 9.0.0 |
