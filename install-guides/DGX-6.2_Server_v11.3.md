# NVIDIA Cloud Native Stack v11.3 - Install Guide for DGX
## Introduction
...
```
```
 sudo apt install -y -q kubelet=1.28.12-00 kubectl=1.28.12-00 kubeadm=1.28.12-00
```
```
...
#yourhost        Ready    control-plane,master   10m   v1.28.12
```
...
Execute the following command to download and install Helm 3.15.3: 
...
gpu-operator-1606173805 nvidia-gpu-operator            1               2024-03-29 20:23:28.063421701 +0000 UTC deployed        gpu-operator-24.3.0      v24.3.0
