<h1>NVIDIA Cloud Native Stack v5.1 for AWS - Install Guide for Ubuntu Server x86-64</h1>
<h2>Introduction</h2>
...
```
helm install --version 1.10.0 --create-namespace --namespace gpu-operator-resources --devel nvidia/gpu-operator  --set operator.defaultRuntime=containerd --set driver.version=470.103.01 --wait --generate-name
```
