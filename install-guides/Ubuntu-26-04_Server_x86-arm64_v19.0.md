# NVIDIA Cloud Native Stack v19.0 - Install Guide for Ubuntu Server
## Introduction
...
- NVIDIA Network Operator 26.1.0
  ...
  - Container Networking Plugins 1.9.1
  - Multus 4.1.0
  - Whereabouts 0.7.0
...
These instructions require installing Ubuntu Server LTS 26.04 Ubuntu Server can be downloaded [here](http://cdimage.ubuntu.com/releases/26.04/release/).
...
#yourhost        Ready    control-plane          10m   v1.36.0
```
