...
GB200 Compute tray must be powered with any of the configuration listed below:
...
This translates into the following settings of the boot configuration:
```
$ cat /proc/cmdline
...
init_on_alloc=0 numa_balancing=disable iommu.passthrough=1
